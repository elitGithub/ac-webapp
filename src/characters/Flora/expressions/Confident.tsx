...
// Confident expression for character Flora
// rv.append(("flora avatar body1",118,153))
// rv.append(("flora avatar face_confident",239,249))
...
// rv.append(("flora avatar b1arm2_n",21,432))
// if "_shirt" in state:
//   if "_skirt" in state:
...
export const FloraConfident: React.FC = () => {
...
export default memo(FloraConfident);
