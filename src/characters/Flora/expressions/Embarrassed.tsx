...
export const FloraEmbarrassed: React.FC = () => {
    ...
    <Expression id="flora" definitions={data.body2}>
      {wet ? (
        <>
          ...
          <Asset name="face_embarrased_wet" layer="base" />
        </>
      ) : (
        <>
          <Asset name="body2" layer="base" />
          <Asset name="face_embarrased" layer="base" />
        </>
      )}
...
export default memo(FloraEmbarrassed);
