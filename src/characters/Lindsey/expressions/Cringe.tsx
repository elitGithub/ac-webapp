...
export const LindseyCringe: React.FC = () => {
  const { panties, bra, towel, skirt, sweatpants, jacket, cropped_hoodie } =
  ...
  return (
    <Expression id="lindsey" definitions={data.body3}>
      ...
      {jacket && <Asset name="b3arm1_c" layer="clothes" />}
