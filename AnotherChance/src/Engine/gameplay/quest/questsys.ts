...
import { ADVANCE_QUEST, AdvanceQuestEvent, QUEST_COMPLETED, QUEST_FAILED, QUEST_STARTED, QUEST_STEP_STARTED, QUEST_TRACKER_CHANGE, QuestTrackerChangeEvent, START_QUEST, StartQuestEvent } from "./model";
...
export class QuestSystem extends GameplaySystem {
    ...
    get mcFocus() {
        if (this.focusedQuest) {
            this.findByTitle(String(this.focusedQuest))
        }
